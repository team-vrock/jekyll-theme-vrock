Gem::Specification.new do |spec|
  ...
  spec.summary       = "A corporate-clean Jekyll theme for technical teams."
  spec.description   = "VROCK is a Jekyll theme for technical teams that publish posts and showcase selected engineering work."
